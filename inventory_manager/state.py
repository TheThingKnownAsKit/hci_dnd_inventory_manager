...
class AppState(rx.State):
    ...
    consumableData: list[Item] = [
        ...
        },
        {
            ...
            "value": "15 SP",
            "category": "potion",
            "description": "This potion’s transparent liquid has floating in it a sliver of fingernail from a giant of the appropriate type. When you drink this potion, your Strength score changes for 1 hour. The type of giant determines the score.",
            "quantity": 1,
            "type": "consumable",
        },
    ]
    ...
    basicData: list[Item] = [
        ...
        },
        {
            ...
            "value": "25 GP",
            "category": "tool",
            "description": "A set of supplies for use in brewing.",
            "quantity": 1,
            "type": "basic",
        },
    ]
    ...
    armorData: list[Armor] = [
        ...
        },
        {
            ...
            "weight": "8",
            "value": "20 GP",
            "description": "Cloth padded with soft material, which provides some amount of defense.",
            "quantity": 1,
            "type": "armor",
        },
    ]
